...
namespace TMPro
{
    ...
    public static class TMP_MaterialManager
    {
        ...
        internal static Material GetFallbackMaterial(TMP_FontAsset fontAsset, Material sourceMaterial, int atlasIndex)
        {
            ...
            // Guard against corrupted font assets where an atlas slot is an unassigned/null texture reference.
            // Without this, tex.GetInstanceID()/tex.name below throw UnassignedReferenceException and break all rendering.
            if (atlasIndex < 0 || atlasIndex >= fontAsset.atlasTextures.Length || fontAsset.atlasTextures[atlasIndex] == null)
